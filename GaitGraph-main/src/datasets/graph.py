...
class Graph():
    ...
    def _get_edge(self):
        if self.dataset == 'kinetics':
            ...
            # neighbor_link = [(0, 1), (1, 2), (1, 5), (1, 15),
            #                  (2, 3), (3, 4), (5, 6), (6, 7),
            #                  (2, 8), (5, 8), (15, 8),
            #                  (8, 9), (9, 10), (10, 11),
            #                  (8, 12), (12, 13), (13, 14)]  # 臀部
            ...
            self.center = 1  # 脊柱为中心节点
            connect_joint = np.array([1, 15, 1, 2, 3, 1, 5, 6, 15, 8, 9, 10, 8, 12, 13, 1])  #
            # connect_joint = np.array([5, 0, 0, 1, 2, 0, 0, 5, 6, 7, 8, 5, 6, 11, 12, 13, 14])  #
            parts = [
                np.array([5, 6, 7]),  # left_arm
                np.array([2, 3, 4]),  # right_arm
                np.array([12, 13, 14]),  # left_leg
                np.array([9, 10, 11]),  # right_leg
                np.array([8, 9, 12]),  # 胯
                np.array([1, 2, 5]),  # 肩
                np.array([0, 1, 15, 8]),  # 脊柱
            ]
            ...
            neighbor_link = [(0, 1), (0, 2), (1, 3), (2, 4), (3, 4), (3, 5), (5, 7), (4, 6),
                             (6, 8), (3, 9), (4, 10), (9, 10), (9, 11), (11, 13), (10, 12), (12, 14)]
            self.edge = self_link + neighbor_link
            self.center = 0  # 鼻子
            # connect_joint = np.array([5, 0, 0, 1, 2, 0, 0, 5, 6, 7, 8, 5, 6, 11, 12, 13, 14])  #
            connect_joint = np.array([5, 0, 0, 0, 0, 3, 4, 5, 6, 3, 4, 9, 10, 11, 12])  #
            parts = [
                np.array([3, 5, 7]),  # left_arm
                np.array([4, 6, 8]),  # right_arm
                np.array([9, 11, 13]),  # left_leg
                np.array([10, 12, 14]),  # right_leg
                np.array([3, 4, 9, 10, 0, 1, 2]),  # torso + head
            ]
