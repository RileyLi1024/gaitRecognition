...
import torch
import sys
sys.path.append('D:/QYJ_1/GaitGraph-main/src/')
...
class MultiInput(object):
    ...
    def __call__(self, data):
        # (C, T, V) -> (I, C * 2, T, V) 60 * 17 *3a b c c 3*60*17 a b
