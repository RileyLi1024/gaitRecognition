...
$(document).ready(function ()
		  {
		     ...
		     {	   
		         ...
		         $.ajax({
		        	 type:'GET',
		        	 url:"<%=request.getContextPath()%>/TSelectvideo",
		        	 data:{f1:f1},
		        	 async: false,
...
<div class="content">
    <div class="sidebar">
  	...
  	<div class="mainbar">
	    <!-- Page heading -->
	    <div class="page-head">
	      <h2 class="pull-left"><i class="icon-home"></i>嫌疑人追踪</h2>
        ...
        <div class="rg_center">
            <div class="rg_form">
                <form action="Dvideo" method="post" id="vi" enctype="multipart/form-data">
                    <table>                                                                    <tr>
                            <td class="td_left">请导入追踪视频</td>
