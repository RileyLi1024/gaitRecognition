 ...
 $(document).ready(function ()
		  {
		     ...
		     {		  
		         ...
		         $.ajax({
		        	 type:'GET',
		        	 url:"<%=request.getContextPath()%>/val_video",
		        	 data:{f1:f1,f2:f2},
		        	 async: false,
    ...
    <div class="sidebar">
       ...
       <li class="has_sub"><a href="#"><i class="icon-list-alt"></i>数据管理<span class="pull-right"><i class="icon-chevron-right"></i></span></a>
          ...
          <li class="has_sub"><a href="#"><i class="icon-list-alt"></i>图卷积步态识别<span class="pull-right"><i class="icon-chevron-right"></i></span></a>
            <ul>
              <li><a href="GraphRegister">嫌疑人录入</a></li>
              <li><a href="GraphTrack">嫌疑人比对</a></li>
							...
							<div class="content-error">
								<div class="hpanel">
									<div class="panel-body">
										<form action="val_video" method="post" id="loginForm" enctype="multipart/form-data">
