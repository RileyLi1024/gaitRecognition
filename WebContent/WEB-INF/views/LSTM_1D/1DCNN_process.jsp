...
<!-- 			<p class="font-bold text-success">两个视频中的人为同一人</p> -->
	    ...
	    <form action="resultone" method="post">
		<button class="btn btn-sm btn-primary login-submit-cs" type="submit" style="Float:left;width:100px;height:50px"><span style="color:white;">相似度分析</span></button>
		</form>
		</div>
