...
$(document).ready(function ()
		  {
		     ...
		     {		                 
		         $.ajax({
		        	 type:'GET',
		        	 url:"<%=request.getContextPath()%>/register_result",	
		        	 async: false,
...
<div class="rg_center">
<form action="register_result" method="post" id="rr" >
	<table>
	<tr>
     <td colspan="2" align="center"><input type="submit" id="btn_s" value="注册" onclick="confirmEx()"></td>
     </tr> 
	</table>
</form>
		</div>
		
<div id="rresult" style="float:left;margin-left:80px;">	
		</div>
