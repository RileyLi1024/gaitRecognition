...
<div class="content">
    <div class="sidebar">
        ...
        <ul id="nav">
          ...
          <li class="has_sub"><a href="#"><i class="icon-list-alt"></i> 方法列表  <span class="pull-right"><i class="icon-chevron-right"></i></span></a>
            <ul>
  	...
  	<div class="mainbar">
	    <!-- Page heading -->
	    <div class="page-head">
	      <h2 class="pull-left"><i class="icon-home"></i>LSTM</h2>
...
<!-- 			<p class="font-bold text-success">两个视频中的人为同一人</p> -->
	    ...
	    <form action="calmatrix" method="post">
		<button class="btn btn-sm btn-primary login-submit-cs" type="submit" style="Float:left;width:100px;height:50px"><span style="color:white;">计算特征矩阵</span></button>
		</form>
		</div>
