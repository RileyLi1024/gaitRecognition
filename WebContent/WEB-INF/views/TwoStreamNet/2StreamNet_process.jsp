...
<!-- 			<p class="font-bold text-success">两个视频中的人为同一人</p> -->
	    ...
	    <form action="2StreamNetfinal_result" method="post">
		<button class="btn btn-sm btn-primary login-submit-cs" type="submit" style="Float:left;width:100px;height:50px"><span style="color:white;">行人判别</span></button>
		</form>
		</div>
		...
		<h3><span class="text" style="position:absolute;left:300px;width:200px;height:50px">识别结果:</span></h3>
		<input type="text" name="识别结果" onfocus="this.blur()" value="${requestScope.fruit}" style="position:absolute;left:450px;width:150px;height:25px">
