...
<body>
  	...
  	<div class="mypicture">
	    ...
	    <div class="video1" id="video1" style="float:left;margin-left:75px;margin-right:150px;" >
...
<!-- 			<p class="font-bold text-success">两个视频中的人为同一人</p> -->
			   <ul>
			   <li><img alt="drawing of a cat" src="video1/${name}" width="400" height="350" /></li>
			   </ul>	
			   </c:forEach>		   		   
	    </div>

        <div class="video2" id="video2" style="position:absolute;left:600px;top:645px" >
			  <div class="loading">Loading...<br /></div>
			   ...
			   <c:forEach items="${requestScope.filename_two}" var="name_two" varStatus="vs">
 			   <ul> 
 			   <li><img alt="drawing of a cat" src="video2/${name_two}" width="400" height="350"/></li>
			   </ul>	 
			   </c:forEach>	
