...
SH_NAMES = ['']*16
SH_NAMES[0]  = 'RFoot'   #' r_ankle'                     RFoot
SH_NAMES[1]  = 'RKnee'   # 'r_knee'                      RKnee
SH_NAMES[2]  = 'RHip'    # 'r_hip'                       RHip
SH_NAMES[3]  = 'LHip'    # 'l_hip'                       LHip
SH_NAMES[4]  = 'LKnee'   # 'l_knee'                      LKnee
SH_NAMES[5]  = 'LFoot'   # 'l_ankle'                     LFoot
SH_NAMES[6]  = 'Hip'     # 'l_hip'  'r_hip'             'Hip'
SH_NAMES[7]  = 'Spine'   #                               Spine
SH_NAMES[8]  = 'Thorax'  #  'l_shoulder' 'r_shoulder'    Thorax
SH_NAMES[9]  = 'Head'    #  'nose'                       Head
SH_NAMES[10] = 'RWrist'  # 'r_wrist'                     RWrist
SH_NAMES[11] = 'RElbow'  # 'r_elbow'                     RElbow
SH_NAMES[12] = 'RShoulder'  # 'r_shoulder',              RShoulder
SH_NAMES[13] = 'LShoulder'  # 'l_shoulder'               LShoulder
SH_NAMES[14] = 'LElbow'     # 'l_elbow'                  LElbow
SH_NAMES[15] = 'LWrist'     # 'l_wrist',                 LWrist
